  ...
  return (
    <Section title="About">
      <p className="my-8">
        ...
        PreComputer 1000 with a 1 line LCD screen that my parents bought me when
        I was 8 or 9. The first thing I did when I got it was open up the
      ...
      <p className="my-8">
        ...
        saving the company time and money by reducing the need for them to send
        a tech out to the store. I eventually earned a position as Assistant IT
        Director.
      </p>

      <p className="my-8">
        I flexed my programming prowess as an Interactive Web Developer for VML.
        I worked alongside some of their best and brightest developing a
        Facebook application for Gatorade. While there, I also carried the torch
        as organizer and speaker for Afternoon Tea, a developer's group aimed at
        raising the bar for front-end standards at VML.
      </p>
      ...
      <p className="my-8">
        ...
        communities in Kansas City and am always looking to expand my network. I
        also really enjoy helping people, so if you need something, let me know!
      </p>
    </Section>
  );
}
